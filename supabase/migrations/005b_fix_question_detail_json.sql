-- =============================================================================
-- Migration 005b: Fix get_question_detail JSON equality error
--
-- PostgreSQL cannot use DISTINCT when a column is JSON type.
-- Restructured activities subquery to avoid DISTINCT on JSON.
-- =============================================================================
...
BEGIN
    ...
    -- Avoid DISTINCT on JSON columns (PG can't compare JSON for equality)
