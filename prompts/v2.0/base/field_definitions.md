...
**Common values (use these when applicable, but may use other values if confident):**
`"CDK4/6 inhibitor"`, `"EGFR TKI"`, `"ALK inhibitor"`, `"ROS1 inhibitor"`, `"KRAS G12C inhibitor"`, `"BRAF inhibitor"`, `"MEK inhibitor"`, `"HER2 TKI"`, `"BTK inhibitor"`, `"BCL-2 inhibitor"`, `"PI3K inhibitor"`, `"AKT inhibitor"`, `"PARP inhibitor"`, `"FLT3 inhibitor"`, `"IDH inhibitor"`, `"JAK inhibitor"`, `"Menin inhibitor"`, `"FGFR inhibitor"`, `"MET inhibitor"`, `"RET inhibitor"`, `"NTRK inhibitor"`, `"Anti-PD-1"`, `"Anti-PD-L1"`, `"Anti-CTLA-4"`, `"Checkpoint inhibitor combination"`, `"CAR-T therapy"`, `"Bispecific T-cell engager"`, `"Bispecific antibody"`, `"Antibody-drug conjugate (ADC)"`, `"HER2-directed ADC"`, `"Trop-2-directed ADC"`, `"BCMA-directed ADC"`, `"Anti-CD20 mAb"`, `"Anti-CD38 mAb"`, `"Anti-HER2 mAb"`, `"Anti-VEGF mAb"`, `"Aromatase inhibitor"`, `"SERD"`, `"IMiD"`, `"Proteasome inhibitor"`, `"Hypomethylating agent"`
